...
- 262 элемента в 13 категориях: от простых состояний до магии и космоса
- 347 рецептов, включая пропорциональные (например, 2 воды + 1 воздух = лёд)

## Особенности

- Drag-and-drop интерфейс (Pointer Events — работает мышью и тачем)
- 262 уникальных элемента в 13 категориях с иконками (глиф + форма + цвет)
- 347 рецептов с системой пропорций

...
export const GLYPH_PATHS = {
  ...
  hopeSym:      { d: 'M10,4 C12,7 12.3,9.5 10,12 C7.7,9.5 8,7 10,4 Z', strokePath: 'M5,6 L5,8 M15,6 L15,8 M6,11 L6,13 M14,11 L14,13', useShapeFill: true, round: true },
  fearSym:      { d: 'M10,3 C6,3 4,7 5,11 C3,13 4,17 8,17 L12,17 C16,17 17,13 15,11 C16,7 14,3 10,3 Z', strokePath: 'M7.5,9 a0.7,0.7 0 1,0 1.4,0 a0.7,0.7 0 1,0 -1.4,0 M11.1,9 a0.7,0.7 0 1,0 1.4,0 a0.7,0.7 0 1,0 -1.4,0', useShapeFill: true, round: true },
  angerSym:     { d: 'M10,2 L11.5,7 L15,4 L13,9 L18,9 L13.5,11.5 L16,16 L11.5,13.5 L10,18 L8.5,13.5 L4,16 L6.5,11.5 L2,9 L7,9 L5,4 L8.5,7 Z', useShapeFill: true, round: true },
  loveSym:      { d: 'M10,16 C10,16 3,10.5 3,6.5 C3,4 5,2.5 7,3 C8.5,3.3 10,5 10,5 C10,5 11.5,3.3 13,3 C15,2.5 17,4 17,6.5 C17,10.5 10,16 10,16 Z', strokePath: 'M15,9 a0.8,0.8 0 1,0 0.01,0', useShapeFill: true, round: true },
  courageSym:   { d: 'M10,2 L15,4 L15,9 C15,13.5 12.5,16.5 10,18 C7.5,16.5 5,13.5 5,9 L5,4 Z', strokePath: 'M10,7 C11.3,9 11.5,10.5 10,12 C8.5,10.5 8.7,9 10,7 Z', useShapeFill: true, round: true },
  serenitySym:  { d: 'M10,7 C11.5,9.5 12,11.5 10,13.5 C8,11.5 8.5,9.5 10,7 Z', strokePath: 'M5,13 a5,2 0 1,0 10,0 a5,2 0 1,0 -10,0 M6.5,15.5 a3.5,1.3 0 1,0 7,0 a3.5,1.3 0 1,0 -7,0', useShapeFill: true, round: true },
  envySym:      { d: 'M3,10 C6,7 14,7 17,10 C14,13 6,13 3,10 Z', strokePath: 'M12,10 a1.6,1.6 0 1,0 3.2,0 a1.6,1.6 0 1,0 -3.2,0', useShapeFill: true, round: true },
  nostalgiaSym: { d: 'M4,4 L16,4 L16,16 L4,16 Z M6,6 L14,6 L14,14 L6,14 Z', strokePath: 'M8,9 a0.8,0.8 0 1,0 0.01,0 M11,11 a0.5,0.5 0 1,0 0.01,0 M9.5,12.5 a0.3,0.3 0 1,0 0.01,0', useShapeFill: true, round: true },
  wonderSym:    { d: 'M2,10 C5,6 15,6 18,10 C15,14 5,14 2,10 Z', strokePath: 'M8.5,10 a1.5,1.5 0 1,0 3,0 a1.5,1.5 0 1,0 -3,0 M10,4 L10,2 M4,7 L2.5,5.5 M16,7 L17.5,5.5 M4,13 L2.5,14.5 M16,13 L17.5,14.5', useShapeFill: true, round: true },
  prideSym:     { d: 'M6,18 L14,18 L13,15 L7,15 Z M8,15 L8,11 C8,9 9,8 10,8 C11,8 12,9 12,11 L12,15 Z', strokePath: 'M8.5,5.5 a1.5,1.5 0 1,0 3,0 a1.5,1.5 0 1,0 -3,0', useShapeFill: true, round: true },
  compassionSym:{ d: 'M3,12 C3,8 6,6 9,7 C6,8 5,10 5,12 C5,14 6,16 9,17 C6,18 3,16 3,12 Z M17,12 C17,8 14,6 11,7 C14,8 15,10 15,12 C15,14 14,16 11,17 C14,18 17,16 17,12 Z', strokePath: 'M9.3,12 a0.7,0.7 0 1,0 1.4,0 a0.7,0.7 0 1,0 -1.4,0', useShapeFill: true, round: true },
  catharsisSym: { d: 'M10,2 L11.5,6 L14,4 L12.5,8 L16,8 L12.5,10 Z M10,2 L8.5,6 L6,4 L7.5,8 L4,8 L7.5,10 Z', strokePath: 'M5,14 a5,1.8 0 1,0 10,0 a5,1.8 0 1,0 -10,0 M6.5,16.3 a3.5,1.2 0 1,0 7,0 a3.5,1.2 0 1,0 -7,0', useShapeFill: true, round: true },
  whisperSym:   { d: 'M4.3,10 a0.9,0.9 0 1,0 1.8,0 a0.9,0.9 0 1,0 -1.8,0', strokePath: 'M7,8 A3,3 0 0,1 7,12 M10,6.5 A6,6 0 0,1 10,13.5', useShapeFill: true, round: true },
  silenceSym:   { d: 'M5,10 a5,5 0 1,0 10,0 a5,5 0 1,0 -10,0', strokePath: 'M4.5,4.5 L15.5,15.5', useShapeFill: true, round: true },
  cacophonySym: { d: 'M2,6 L5,9 L3,11 L7,13 M9,4 L11,8 L8,10 L13,14 M14,6 L12,10 L16,11 L13,15', round: true },
  harmonySym:   { d: 'M4,14 A8,8 0 0,1 4,6 M6.5,13 A5.5,5.5 0 0,1 6.5,7 M9,12 A3,3 0 0,1 9,8', round: true },
  thunderclapSym:{ d: 'M11,2 L6,11 L9,11 L8,18 L14,9 L11,9 Z', strokePath: 'M5,14 L7,13 M11,15 L13,14', useShapeFill: true, round: true },
  reverberationSym:{ d: 'M4,10 a1,1 0 1,0 2,0 a1,1 0 1,0 -2,0', strokePath: 'M8,6 A6,6 0 0,1 8,14 M11,4 A9,9 0 0,1 11,16 M14,2.5 A11.5,11.5 0 0,1 14,17.5', useShapeFill: true, round: true },
  lullabySym:   { d: 'M12,3 C8,3 5,6.5 5,10 C5,13.5 8,17 12,17 C9,15.5 7.5,13 7.5,10 C7.5,7 9,4.5 12,3 Z', strokePath: 'M14,6 C14,6 15.5,6.3 15.3,7.5 M15,10.5 C15,10.5 16.3,10.9 16,12', useShapeFill: true, round: true },
...
export const ICON_DESIGNS = {
  ...
  hope:      { shape: 'circle',  glyph: 'hopeSym',           rot: 0 },
  fear:      { shape: 'hexagon', glyph: 'fearSym',           rot: 0 },
  anger:     { shape: 'star',    glyph: 'angerSym',          rot: 0 },
  love:      { shape: 'circle',  glyph: 'loveSym',           rot: 0 },
  courage:   { shape: 'hexagon', glyph: 'courageSym',        rot: 0 },
  serenity:  { shape: 'circle',  glyph: 'serenitySym',       rot: 0 },
  envy:      { shape: 'diamond', glyph: 'envySym',           rot: 0 },
  nostalgia: { shape: 'square',  glyph: 'nostalgiaSym',      rot: 0 },
  wonder:    { shape: 'star',    glyph: 'wonderSym',         rot: 0 },
  pride:     { shape: 'triangle',glyph: 'prideSym',          rot: 0 },
  compassion:{ shape: 'circle',  glyph: 'compassionSym',     rot: 0 },
  catharsis: { shape: 'star',    glyph: 'catharsisSym',      rot: 0 },
  whisper:   { shape: 'circle',  glyph: 'whisperSym',        rot: 0 },
  silence:   { shape: 'circle',  glyph: 'silenceSym',        rot: 0 },
  cacophony: { shape: 'triangle',glyph: 'cacophonySym',      rot: 0 },
  harmony:   { shape: 'hexagon', glyph: 'harmonySym',        rot: 0 },
  thunderclap:{ shape: 'diamond',glyph: 'thunderclapSym',    rot: 0 },
  reverberation:{ shape: 'circle', glyph: 'reverberationSym',rot: 0 },
  lullaby:   { shape: 'circle',  glyph: 'lullabySym',        rot: 0 },
